...
public class AddForumRequest {
    ...
    public AddForumRequest(Context mContext, ForumCallback callback, final String iphone, final String title, final String content) {
        this.mContext = mContext;
        this.callback = callback;
        new Thread(new Runnable() {
            @Override
            public void run() {
                forumPost(iphone, title, content);
            }
        }).start();
    }

    private void forumPost(String iphone, String title, String content) {
...
//                    + "email:"+email+","
    ...
    private ArrayList<ForumBean> FormatForumBean(String json) {
        ...
        Type listType = new TypeToken<List<ForumBean>>() {
        }.getType();
        Gson gson = new Gson();
