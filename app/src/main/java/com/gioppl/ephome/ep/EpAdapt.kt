 ...
 */
class EpAdapt (private var mList:ArrayList<EpEntity>, private var context: Context): RecyclerView.Adapter<EpAdapt.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.lin!!.setOnClickListener(View.OnClickListener {
            EventBus.getDefault().postSticky(PollutionEntity(mod.title,mod.content));
